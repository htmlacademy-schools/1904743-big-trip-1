...
const generateCity = list => list[(0,_utils_common__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(1, list.length - 1)];
...
const generateTimeBegin = () => {
  ...
  return dayjs__WEBPACK_IMPORTED_MODULE_0___default()().add(MinutesGap, 'minute');
};

const generateTimeEnd = () => {
  const maxMinutesGap = 360;
  const MinutesGap = (0,_utils_common__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(200, maxMinutesGap);
  return dayjs__WEBPACK_IMPORTED_MODULE_0___default()().add(MinutesGap, 'minute');
};

const generateDuration = (timeBegin, timeEnd) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()(timeEnd - timeBegin).subtract(5, 'hour');
...
class PointPresenter {
  constructor(eventListContainer, changeData, changeMode) {
    ...
    _defineProperty(this, "resetView", () => {
      if (_classPrivateFieldGet(this, _mode) !== Mode.DEFAULT) {
        _classPrivateFieldGet(this, _eventEditComponent).reset(_classPrivateFieldGet(this, _event));
...
/* harmony import */ var _utils_wayPoint_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/wayPoint.js */ "./src/utils/wayPoint.js");
...
var _handleEventsChange = /*#__PURE__*/new WeakMap();

var _sortEvents = /*#__PURE__*/new WeakMap();
...
var _clearEventsList = /*#__PURE__*/new WeakMap();
...
class TripPresenter {
  constructor(tripContainer) {
    ...
    _classPrivateFieldInitSpec(this, _currentSortType, {
      writable: true,
      value: _const_js__WEBPACK_IMPORTED_MODULE_6__.SortType.Day
    });
    ...
    _defineProperty(this, "init", tripEvents => {
      _classPrivateFieldSet(this, _tripEvents, [...tripEvents].sort(_utils_wayPoint_js__WEBPACK_IMPORTED_MODULE_5__.sortEvents));

      _classPrivateFieldSet(this, _sourcedTripEvents, [..._classPrivateFieldGet(this, _tripEvents)]);
    ...
    _classPrivateFieldInitSpec(this, _handleEventsChange, {
      writable: true,
      value: updatedEvent => {
        ...
        _classPrivateFieldSet(this, _sourcedTripEvents, (0,_utils_common__WEBPACK_IMPORTED_MODULE_4__.updateItem)(_classPrivateFieldGet(this, _sourcedTripEvents), updatedEvent));

        _classPrivateFieldGet(this, _pointPresenter).get(updatedEvent.id).init(updatedEvent);
      }
    });

    _classPrivateFieldInitSpec(this, _sortEvents, {
      writable: true,
      value: sortType => {
        switch (sortType) {
          case _const_js__WEBPACK_IMPORTED_MODULE_6__.SortType.Price:
            _classPrivateFieldGet(this, _tripEvents).sort(_utils_wayPoint_js__WEBPACK_IMPORTED_MODULE_5__.sortEventPrice);

            break;

          case _const_js__WEBPACK_IMPORTED_MODULE_6__.SortType.Time:
            _classPrivateFieldGet(this, _tripEvents).sort(_utils_wayPoint_js__WEBPACK_IMPORTED_MODULE_5__.sortEventTime);

            break;

          case _const_js__WEBPACK_IMPORTED_MODULE_6__.SortType.Day:
    ...
    _classPrivateFieldInitSpec(this, _handleSortTypeChange, {
      ...
      value: sortType => {
        ...
        _classPrivateFieldGet(this, _sortEvents).call(this, sortType);

        _classPrivateFieldGet(this, _clearEventsList).call(this);
    ...
    _classPrivateFieldInitSpec(this, _renderEvent, {
      writable: true,
      value: event => {
        const pointPresenter = new _point_presenter__WEBPACK_IMPORTED_MODULE_7__["default"](_classPrivateFieldGet(this, _eventsListComponent), _classPrivateFieldGet(this, _handleEventsChange), _classPrivateFieldGet(this, _handleModeChange));
    ...
    _classPrivateFieldInitSpec(this, _clearEventsList, {
      writable: true,
      value: () => {
...
/* harmony export */   "offersFilter": () => (/* binding */ offersFilter),
/* harmony export */   "destinationFilter": () => (/* binding */ destinationFilter)
/* harmony export */ });
const sortEventTime = (eventA, eventB) => eventB.duration - eventA.duration;
const sortEventPrice = (eventA, eventB) => eventB.price - eventA.price;
const sortEvents = (eventA, eventB) => eventA.dates - eventB.dates;
const offersFilter = (offer, pointType) => {
...
const destinationFilter = (city, destination) => {
...
/* harmony import */ var _utils_wayPoint__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/wayPoint */ "./src/utils/wayPoint.js");
function _classPrivateFieldInitSpec(obj, privateMap, value) { _checkPrivateRedeclaration(obj, privateMap); privateMap.set(obj, value); }
...
const BLANK_WAYPOINT = {
  city: '',
  pointType: _const__WEBPACK_IMPORTED_MODULE_2__.TYPE[0],
  price: '',
  description: '',
  offers: [],
  pictures: [],
...
const createEventEditTypeTemplate = currentType => _const__WEBPACK_IMPORTED_MODULE_2__.TYPE.map(type => `
...
const createEditPointTemplate = data => {
  ...
  const currentOffers = (0,_utils_wayPoint__WEBPACK_IMPORTED_MODULE_3__.offersFilter)(offers, pointType);
  ...
  const currentDestination = (0,_utils_wayPoint__WEBPACK_IMPORTED_MODULE_3__.destinationFilter)(city, destination);
...
var _cityToggleHandler = /*#__PURE__*/new WeakMap();
...
class EditPointView extends _smart_view__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(wayPoint = BLANK_WAYPOINT) {
    ...
    _defineProperty(this, "reset", event => {
      this.updateData(EditPointView.parseEventToData(event));
    });
    ...
    _classPrivateFieldInitSpec(this, _cityToggleHandler, {
      writable: true,
      value: evt => {
        evt.preventDefault();
        this.updateData({
    ...
    _classPrivateFieldInitSpec(this, _setInnerHandlers, {
      writable: true,
      value: () => {
        this.element.querySelector('.event__type-list').addEventListener('change', _classPrivateFieldGet(this, _typeToggleHandler));
        this.element.querySelector('.event__field-group').addEventListener('change', _classPrivateFieldGet(this, _cityToggleHandler));
      }
    });
...
_defineProperty(EditPointView, "parseEventToData", event => ({ ...event
}));

_defineProperty(EditPointView, "parseDataToEvent", data => ({ ...data
}));
...
/* harmony import */ var _utils_wayPoint__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/wayPoint */ "./src/utils/wayPoint.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
const createWayPointTemplate = wayPoint => {
  ...
  const currentOffers = (0,_utils_wayPoint__WEBPACK_IMPORTED_MODULE_2__.offersFilter)(offers, pointType);
  const date = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dates).format('MMM D');
  const timeStart = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(timeBegin).format('hh:mm');
  const timeFinish = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(timeEnd).format('hh:mm');
  const durationEvent = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(duration).format('h[H] m[M]');
